...
csvjoin -c supplier_id --left on_market.products_rich.csv export_suppliers.csv > on_market.products_rich.withSupplierNames.csv

# Join Category Names to full feed (flat categories assumed - would be nice to be able to reference categories by externalId. 
csvjoin -c Category_ID,catid --left on_market.products_rich.withSupplierNames.csv categoryNames_en.csv > on_market.products_rich.withSupplierNames.withCategoryNames.csv
...
# -> cat 151 = notebooks
csvgrep -c catid -r "^151$" on_market.products_rich.withSupplierNames.withCategoryNames.csv > on_market.products_rich.notebooksWithAll.csv
csvgrep -c catid -r "^3005$" on_market.products_rich.withSupplierNames.withCategoryNames.csv > on_market.products_rich.lipsticksWithAll.csv
